...
\example{1D Finite Differences, Gradient}{
    ...
    $$\frac{\partial}{\partial x}u(x_i) \approx \frac{u(x_{i+1}) - u(x_{i-1})}{x_{i+1} - x_{i-1}} = \frac{u(x_{i+1}) - u(x_{i-1})}{2h}$$ 
...
\example{1D Finite Differences, Laplacian}{
